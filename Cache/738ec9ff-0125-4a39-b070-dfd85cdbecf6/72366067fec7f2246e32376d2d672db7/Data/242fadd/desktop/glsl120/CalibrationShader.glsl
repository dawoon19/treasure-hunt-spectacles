...
//sampler sampler IconTexSmpSC 2:16
...
//texture texture2D IconTex 2:0:2:16
...
uniform float CurrSize;
uniform vec4 LoadingColor;
uniform float Amount;
uniform vec4 StartColor;
uniform float StartSize;
uniform vec4 IconTexSize;
uniform vec4 IconTexView;
uniform mat3 IconTexTransform;
uniform vec4 IconTexUvMinMax;
uniform vec4 IconTexBorderColor;
uniform float Port_Rotation_N014;
uniform vec2 Port_Center_N014;
uniform vec2 Port_Offset_N013;
uniform float Port_Import_N177;
uniform float Port_Import_N179;
uniform float Port_Input0_N008;
...
uniform float Port_RangeMaxA_N029;
uniform float Port_RangeMinB_N029;
uniform float Port_RangeMaxB_N029;
uniform vec2 Port_Center_N026;
uniform float Port_RangeMinA_N032;
uniform float Port_RangeMinB_N032;
uniform float Port_RangeMaxB_N032;
...
#endif
#ifndef IconTexHasSwappedViews
#define IconTexHasSwappedViews 0
#elif IconTexHasSwappedViews==1
#undef IconTexHasSwappedViews
#define IconTexHasSwappedViews 1
#endif
#ifndef IconTexLayout
#define IconTexLayout 0
#endif
#ifndef SC_USE_UV_TRANSFORM_IconTex
#define SC_USE_UV_TRANSFORM_IconTex 0
#elif SC_USE_UV_TRANSFORM_IconTex==1
#undef SC_USE_UV_TRANSFORM_IconTex
#define SC_USE_UV_TRANSFORM_IconTex 1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_U_IconTex
#define SC_SOFTWARE_WRAP_MODE_U_IconTex -1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_V_IconTex
#define SC_SOFTWARE_WRAP_MODE_V_IconTex -1
#endif
#ifndef SC_USE_UV_MIN_MAX_IconTex
#define SC_USE_UV_MIN_MAX_IconTex 0
#elif SC_USE_UV_MIN_MAX_IconTex==1
#undef SC_USE_UV_MIN_MAX_IconTex
#define SC_USE_UV_MIN_MAX_IconTex 1
#endif
#ifndef SC_USE_CLAMP_TO_BORDER_IconTex
#define SC_USE_CLAMP_TO_BORDER_IconTex 0
#elif SC_USE_CLAMP_TO_BORDER_IconTex==1
#undef SC_USE_CLAMP_TO_BORDER_IconTex
#define SC_USE_CLAMP_TO_BORDER_IconTex 1
#endif
#ifndef sc_DepthOnly
...
varying vec2 varScreenTexturePos;
varying vec4 varColor;
void Node14_Rotate_Coords(vec2 CoordsIn,float Rotation,vec2 Center,out vec2 CoordsOut,ssGlobals Globals)
{
...
int IconTexGetStereoViewIndex()
{
int l9_0;
#if (IconTexHasSwappedViews)
{
...
vec2 l9_4;
Node14_Rotate_Coords(varPackedTex.xy,Port_Rotation_N014,Port_Center_N014,l9_4,l9_3);
vec2 l9_5=l9_4;
vec2 l9_6=l9_5+Port_Offset_N013;
float l9_7=l9_6.x;
float l9_8=l9_6.y;
...
float l9_11=Port_Input0_N008-CurrSize;
vec3 l9_12;
if ((float(l9_10<l9_11)*1.0)!=0.0)
{
l9_12=LoadingColor.xyz;
}
else
{
vec2 l9_13;
Node14_Rotate_Coords(varPackedTex.xy,Port_Rotation_N014,Port_Center_N014,l9_13,l9_3);
vec2 l9_14=l9_13;
vec2 l9_15=l9_14+Port_Offset_N013;
float l9_16=l9_15.x;
float l9_17=l9_15.y;
float l9_18=(l9_16*l9_16)+(l9_17*l9_17);
float l9_19;
if (l9_18<=0.0)
{
l9_19=0.0;
...
bool l9_20=l9_19<l9_11;
bool l9_21=l9_19>(Port_Input0_N018+CurrSize);
bool l9_22=(float(l9_20)*1.0)!=0.0;
bool l9_23;
if (!l9_22)
{
l9_23=(float(l9_21)*1.0)!=0.0;
}
else
{
l9_23=l9_22;
...
bool l9_25=((1.0-l9_24)*1.0)!=0.0;
bool l9_26;
if (l9_25)
{
l9_26=(float(atan(l9_17,l9_16)<=((((Amount-Port_RangeMinA_N010)/(Port_RangeMaxA_N010-Port_RangeMinA_N010))*(Port_RangeMaxB_N010-Port_RangeMinB_N010))+Port_RangeMinB_N010))*1.0)!=0.0;
}
else
{
l9_26=l9_25;
...
vec3 l9_27;
if ((float(l9_26)*1.0)!=0.0)
{
l9_27=LoadingColor.xyz;
}
else
{
l9_27=StartColor.xyz;
}
l9_12=l9_27;
}
vec2 param_3;
Node14_Rotate_Coords(varPackedTex.xy,Port_Rotation_N014,Port_Center_N014,param_3,l9_3);
vec2 l9_28=param_3;
vec2 l9_29=l9_28+Port_Offset_N013;
float l9_30=l9_29.x;
float l9_31=l9_29.y;
float l9_32=(l9_30*l9_30)+(l9_31*l9_31);
float l9_33;
if (l9_32<=0.0)
{
l9_33=0.0;
...
bool l9_34=l9_33<l9_11;
bool l9_35=l9_33>(Port_Input0_N018+CurrSize);
bool l9_36=(float(l9_34)*1.0)!=0.0;
bool l9_37;
if (!l9_36)
{
l9_37=(float(l9_35)*1.0)!=0.0;
}
else
{
l9_37=l9_36;
...
float l9_39;
if ((float(CurrSize>=StartSize)*1.0)!=0.0)
{
l9_39=sc_SampleTextureBiasOrLevel(IconTexDims.xy,IconTexLayout,IconTexGetStereoViewIndex(),((varPackedTex.xy-Port_Center_N026)*vec2((((CurrSize-StartSize)/(Port_RangeMaxA_N029-StartSize))*(Port_RangeMaxB_N029-Port_RangeMinB_N029))+Port_RangeMinB_N029))+Port_Center_N026,(int(SC_USE_UV_TRANSFORM_IconTex)!=0),IconTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex),(int(SC_USE_UV_MIN_MAX_IconTex)!=0),IconTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_IconTex)!=0),IconTexBorderColor,0.0,IconTex).w;
}
else
{
l9_39=(vec2(sc_SampleTextureBiasOrLevel(IconTexDims.xy,IconTexLayout,IconTexGetStereoViewIndex(),((varPackedTex.xy-Port_Center_N026)*vec2((((CurrSize-StartSize)/(Port_RangeMaxA_N029-StartSize))*(Port_RangeMaxB_N029-Port_RangeMinB_N029))+Port_RangeMinB_N029))+Port_Center_N026,(int(SC_USE_UV_TRANSFORM_IconTex)!=0),IconTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex),(int(SC_USE_UV_MIN_MAX_IconTex)!=0),IconTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_IconTex)!=0),IconTexBorderColor,0.0,IconTex).w)*vec2((((CurrSize-Port_RangeMinA_N032)/(StartSize-Port_RangeMinA_N032))*(Port_RangeMaxB_N032-Port_RangeMinB_N032))+Port_RangeMinB_N032)).x;
}
float l9_40=(1.0-l9_38)+l9_39;
vec4 l9_41=vec4(l9_12.x,l9_12.y,l9_12.z,vec4(0.0).w);
l9_41.w=l9_40;
