...
#endif
float l9_0=length(sc_ModelMatrix[0].xyz);
float l9_1=length(sc_ModelMatrix[1].xyz);
float l9_2=min(min(clamp(borderScale,0.0,1.0),l9_0/2.0),l9_1/2.0);
float l9_3=(baseTexSize.x/baseTexSize.y)*l9_2;
float l9_4=((sliceSizeLeft*l9_3)*2.0)/l9_0;
float l9_5=1.0-(((sliceSizeRight*l9_3)*2.0)/l9_0);
float l9_6=((sliceSizeBottom*l9_2)*2.0)/l9_1;
float l9_7=1.0-(((sliceSizeTop*l9_2)*2.0)/l9_1);
float l9_8=1.0-sliceSizeRight;
float l9_9=1.0-sliceSizeTop;
float l9_10;
if (varPackedTex.x<l9_4)
{
l9_10=0.0+(((varPackedTex.x-0.0)*(sliceSizeLeft-0.0))/(l9_4-0.0));
}
else
{
l9_10=(varPackedTex.x<l9_5) ? (sliceSizeLeft+(((varPackedTex.x-l9_4)*(l9_8-sliceSizeLeft))/(l9_5-l9_4))) : (l9_8+(((varPackedTex.x-l9_5)*(1.0-l9_8))/(1.0-l9_5)));
}
float l9_11;
if (varPackedTex.y<l9_6)
{
l9_11=0.0+(((varPackedTex.y-0.0)*(sliceSizeBottom-0.0))/(l9_6-0.0));
}
else
{
l9_11=(varPackedTex.y<l9_7) ? (sliceSizeBottom+(((varPackedTex.y-l9_6)*(l9_9-sliceSizeBottom))/(l9_7-l9_6))) : (l9_9+(((varPackedTex.y-l9_7)*(1.0-l9_9))/(1.0-l9_7)));
}
...
#endif
vec4 l9_14=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,l9_13,l9_12,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex);
float l9_15=l9_14.w;
#if (sc_BlendMode_AlphaTest)
{
if (l9_15<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_15<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_19=clamp(dot(l9_14.xyz,vec3(l9_15)),0.0,1.0);
}
#else
{
float l9_20;
...
{
l9_21=(1.0-dot(l9_14.xyz,vec3(0.33333001)))*l9_15;
}
#else
{
float l9_22;
...
{
l9_22=(1.0-clamp(dot(l9_14.xyz,vec3(1.0)),0.0,1.0))*l9_15;
}
#else
{
float l9_23;
...
{
l9_23=clamp(dot(l9_14.xyz,vec3(1.0)),0.0,1.0)*l9_15;
}
#else
{
float l9_24;
#if (sc_BlendMode_Add)
{
l9_24=clamp(dot(l9_14.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_25;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_25=clamp(dot(l9_14.xyz,vec3(1.0)),0.0,1.0)*l9_15;
}
#else
{
float l9_26;
...
{
l9_26=dot(l9_14.xyz,vec3(0.33333001))*l9_15;
}
#else
{
float l9_27;
#if (sc_BlendMode_Min)
{
l9_27=1.0-clamp(dot(l9_14.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_28;
#if (sc_BlendMode_Max)
{
l9_28=clamp(dot(l9_14.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_28=1.0;
...
#endif
l9_16=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_14.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_17);
}
#else
{
vec4 l9_29;
...
#endif
vec3 l9_39=mix(l9_37.xyz,definedBlend(l9_37.xyz,l9_14.xyz).xyz,vec3(l9_15));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_41=vec4(mix(vec3(1.0),l9_14.xyz,vec3(l9_15)),l9_15);
}
#else
{
vec4 l9_42;
...
#endif
l9_42=vec4(l9_14.xyz*l9_43,l9_43);
}
#else
{
l9_42=l9_14;
