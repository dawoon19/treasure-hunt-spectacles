...
//float borderScale 4208
//float sliceSizeLeft 4212
//float sliceSizeRight 4216
//float sliceSizeTop 4220
//float sliceSizeBottom 4224
//float2 Port_Import_N025 4232
//float Port_Import_N017 4240
//float Port_Import_N011 4244
//float Port_Import_N035 4248
//float Port_Import_N028 4252
//float Port_Import_N038 4256
//float2 Port_Import_N082 4264
//float depthRef 4272
//}
...
float2 param=(*sc_set2.UserUniforms).baseTexSize.xy;
...
float param_1=(*sc_set2.UserUniforms).borderScale;
Output_N10=param_1;
float Value_N17=0.0;
Value_N17=fast::clamp(Output_N10,0.0,1.0);
float Output_N9=0.0;
float param_2=(*sc_set2.UserUniforms).sliceSizeLeft;
Output_N9=param_2;
float Value_N11=0.0;
Value_N11=Output_N9;
float Output_N36=0.0;
float param_3=(*sc_set2.UserUniforms).sliceSizeRight;
Output_N36=param_3;
float Value_N35=0.0;
Value_N35=Output_N36;
float Output_N8=0.0;
float param_4=(*sc_set2.UserUniforms).sliceSizeTop;
Output_N8=param_4;
float Value_N28=0.0;
Value_N28=Output_N8;
float Output_N13=0.0;
float param_5=(*sc_set2.UserUniforms).sliceSizeBottom;
Output_N13=param_5;
float Value_N38=0.0;
...
N24_UV=param_6;
N24_BorderScale=param_7;
N24_SliceLeft=param_8;
N24_SliceRight=param_9;
N24_SliceTop=param_10;
N24_SliceBottom=param_11;
N24_TextureSize=param_12;
float4x4 l9_7=(*sc_set2.UserUniforms).sc_ModelMatrix;
float l9_8=length(l9_7[0].xyz);
float4x4 l9_9=(*sc_set2.UserUniforms).sc_ModelMatrix;
float l9_10=length(l9_9[1].xyz);
float2 l9_11=float2(l9_8,l9_10);
float l9_12=N24_BorderScale;
float l9_13=l9_11.x;
float l9_14=l9_11.y;
float l9_15=fast::min(fast::min(l9_12,l9_13/2.0),l9_14/2.0);
float l9_16=l9_15;
float2 l9_17=N24_TextureSize;
float l9_18=l9_16;
float2 l9_19=float2((l9_17.x/l9_17.y)*l9_18,l9_18);
float2 l9_20=l9_19;
float l9_21=((N24_SliceLeft*l9_20.x)*2.0)/l9_11.x;
float l9_22=1.0-(((N24_SliceRight*l9_20.x)*2.0)/l9_11.x);
float l9_23=((N24_SliceBottom*l9_20.y)*2.0)/l9_11.y;
float l9_24=1.0-(((N24_SliceTop*l9_20.y)*2.0)/l9_11.y);
float l9_25=0.0+(((N24_UV.x-0.0)*(N24_SliceLeft-0.0))/(l9_21-0.0));
float l9_26=N24_SliceLeft+(((N24_UV.x-l9_21)*((1.0-N24_SliceRight)-N24_SliceLeft))/(l9_22-l9_21));
float l9_27=(1.0-N24_SliceRight)+(((N24_UV.x-l9_22)*(1.0-(1.0-N24_SliceRight)))/(1.0-l9_22));
float l9_28=0.0+(((N24_UV.y-0.0)*(N24_SliceBottom-0.0))/(l9_23-0.0));
float l9_29=N24_SliceBottom+(((N24_UV.y-l9_23)*((1.0-N24_SliceTop)-N24_SliceBottom))/(l9_24-l9_23));
float l9_30=(1.0-N24_SliceTop)+(((N24_UV.y-l9_24)*(1.0-(1.0-N24_SliceTop)))/(1.0-l9_24));
float l9_31;
if (N24_UV.x<l9_21)
{
l9_31=l9_25;
...
{
l9_31=(N24_UV.x<l9_22) ? l9_26 : l9_27;
}
float l9_32=l9_31;
float l9_33;
if (N24_UV.y<l9_23)
...
{
l9_33=(N24_UV.y<l9_24) ? l9_29 : l9_30;
}
float l9_34=l9_33;
N24_Result=float2(l9_32,l9_34);
param_13=N24_Result;
Result_N24=param_13;
...
float3x3 param_18=(*sc_set2.UserUniforms).baseTexTransform;
...
float4 param_21=(*sc_set2.UserUniforms).baseTexUvMinMax;
bool param_22=(int(SC_USE_CLAMP_TO_BORDER_baseTex_tmp)!=0);
float4 param_23=(*sc_set2.UserUniforms).baseTexBorderColor;
float param_24=0.0;
bool l9_41=param_22&&(!param_20);
float l9_42=1.0;
float l9_43=param_16.x;
int l9_44=param_19.x;
if (l9_44==1)
{
l9_43=fract(l9_43);
}
...
param_16.x=l9_43;
float l9_48=param_16.y;
int l9_49=param_19.y;
if (l9_49==1)
{
l9_48=fract(l9_48);
}
...
if (l9_49==2)
{
float l9_50=fract(l9_48);
float l9_51=l9_48-l9_50;
float l9_52=step(0.25,fract(l9_51*0.5));
l9_48=mix(l9_50,1.0-l9_50,fast::clamp(l9_52,0.0,1.0));
}
}
param_16.y=l9_48;
if (param_20)
...
float l9_55=param_16.x;
float l9_56=param_21.x;
float l9_57=param_21.z;
bool l9_58=l9_54;
float l9_59=l9_42;
...
float l9_65=param_21.y;
float l9_66=param_21.w;
bool l9_67=l9_63;
float l9_68=l9_42;
...
float2 l9_71=param_16;
bool l9_72=param_17;
float3x3 l9_73=param_18;
if (l9_72)
{
l9_71=float2((l9_73*float3(l9_71,1.0)).xy);
}
float2 l9_74=l9_71;
float2 l9_75=l9_74;
float2 l9_76=l9_75;
param_16=l9_76;
float l9_77=param_16.x;
int l9_78=param_19.x;
bool l9_79=l9_41;
float l9_80=l9_42;
if ((l9_78==0)||(l9_78==3))
{
...
param_16.x=l9_77;
l9_42=l9_80;
float l9_88=param_16.y;
int l9_89=param_19.y;
bool l9_90=l9_41;
float l9_91=l9_42;
if ((l9_89==0)||(l9_89==3))
{
...
param_16.y=l9_88;
l9_42=l9_91;
float2 l9_99=param_16;
int l9_100=param_14;
int l9_101=param_15;
float l9_102=param_24;
float2 l9_103=l9_99;
int l9_104=l9_100;
int l9_105=l9_101;
...
float l9_110=l9_102;
float4 l9_111=sc_set2.baseTex.sample(sc_set2.baseTexSmpSC,l9_109,bias(l9_110));
float4 l9_112=l9_111;
float4 l9_113=l9_112;
if (param_22)
{
l9_113=mix(param_23,l9_113,float4(l9_42));
}
...
{
if (param_25<(*sc_set2.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
float2 l9_116=floor(mod(l9_115.xy,float2(4.0)));
float l9_117=(mod(dot(l9_116,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_25<l9_117)
{
discard_fragment();
}
}
bool l9_118=(*sc_set2.UserUniforms).isProxyMode!=0;
if (l9_118)
{
...
float4 l9_119=fast::max(param_26,float4(0.0));
float4 param_27=l9_119;
...
{
l9_122=fast::clamp(l9_121.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_122=fast::clamp(dot(l9_121.xyz,float3(l9_121.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_122=(1.0-dot(l9_121.xyz,float3(0.33333001)))*l9_121.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_122=(1.0-fast::clamp(dot(l9_121.xyz,float3(1.0)),0.0,1.0))*l9_121.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_122=fast::clamp(dot(l9_121.xyz,float3(1.0)),0.0,1.0)*l9_121.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_122=fast::clamp(dot(l9_121.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_122=dot(l9_121.xyz,float3(0.33333001))*l9_121.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_122=1.0-fast::clamp(dot(l9_121.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_123=l9_122;
float l9_124=l9_123;
float l9_125=(*sc_set2.UserUniforms).sc_ShadowDensity*l9_124;
float3 l9_126=mix((*sc_set2.UserUniforms).sc_ShadowColor.xyz,(*sc_set2.UserUniforms).sc_ShadowColor.xyz*l9_120.xyz,float3((*sc_set2.UserUniforms).sc_ShadowColor.w));
float4 l9_127=float4(l9_126.x,l9_126.y,l9_126.z,l9_125);
param_28=l9_127;
}
else
{
...
{
float4 l9_128=param_28;
float4 l9_129=float4(0.0);
float4 l9_130=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_131=out.FragColor0;
float4 l9_132=l9_131;
if ((int(sc_UseFramebufferFetchMarker_tmp)!=0))
{
l9_132.x+=(*sc_set2.UserUniforms)._sc_framebufferFetchMarker;
}
...
float2 l9_135=(l9_134.xy*(*sc_set2.UserUniforms).sc_WindowToViewportTransform.xy)+(*sc_set2.UserUniforms).sc_WindowToViewportTransform.zw;
...
int l9_140=l9_139;
int l9_141=l9_140;
float3 l9_142=float3(l9_136,0.0);
int l9_143=l9_138;
int l9_144=l9_141;
if (l9_143==1)
{
l9_142.y=((2.0*l9_142.y)+float(l9_144))-1.0;
}
float2 l9_145=l9_142.xy;
l9_137=l9_145;
}
else
{
...
int l9_154=l9_149;
float2 l9_155=l9_148;
int l9_156=l9_154;
float2 l9_157=l9_155;
int l9_158=l9_156;
float l9_159=0.0;
...
float l9_172=l9_164;
float4 l9_173=sc_set2.sc_ScreenTexture.sample(sc_set2.sc_ScreenTextureSmpSC,l9_171,bias(l9_172));
float4 l9_174=l9_173;
l9_160=l9_174;
float4 l9_175=l9_160;
float4 l9_176=l9_175;
float4 l9_177=l9_176;
l9_130=l9_177;
}
float4 l9_178=l9_130;
float4 l9_179=l9_178;
float3 l9_180=l9_179.xyz;
float3 l9_181=l9_180;
float3 l9_182=l9_128.xyz;
float3 l9_183=definedBlend(l9_181,l9_182,in.varStereoViewID,(*sc_set2.UserUniforms),sc_set2.intensityTexture,sc_set2.intensityTextureSmpSC);
l9_129=float4(l9_183.x,l9_183.y,l9_183.z,l9_129.w);
float3 l9_184=mix(l9_180,l9_129.xyz,float3(l9_128.w));
l9_129=float4(l9_184.x,l9_184.y,l9_184.z,l9_129.w);
l9_129.w=1.0;
float4 l9_185=l9_129;
param_28=l9_185;
}
else
{
float4 l9_186=param_28;
...
{
l9_191=float4((*sc_set2.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_191=float4(0.0);
...
FinalColor=outputMotionVectorsIfNeeded(param_29,param_30,in.varStereoViewID,(*sc_set2.UserUniforms));
float4 param_31=FinalColor;
float4 l9_193=param_31;
