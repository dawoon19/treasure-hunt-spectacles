...
#define UseViewSpaceDepthVariant 1
#endif
#ifndef NODE_25_DROPLIST_ITEM
#define NODE_25_DROPLIST_ITEM 0
#endif
...
uniform vec4 Port_Input0_N028;
uniform float Port_Position1_N036;
uniform float Port_Position2_N036;
uniform vec3 Port_Normal_N037;
uniform float Port_Exponent_N037;
uniform float Port_Intensity_N037;
...
vec3 l9_31;
#if (NODE_25_DROPLIST_ITEM==0)
{
float l9_32=floor(float(sc_GetLocalInstanceID())+0.5);
l9_31=vec3((l9_32-((sc_GeometryInfo.y-Port_Input1_N023)/Port_Input1_N021))*spacing,floatArray[int(clamp(l9_32+9.9999997e-05,0.0,7.0))]*instensity,Port_Value3_N017);
}
#else
{
vec3 l9_33;
#if (NODE_25_DROPLIST_ITEM==1)
{
float l9_34=((floor(float(sc_GetLocalInstanceID())+0.5)/sc_GeometryInfo.y)*3.1415927)*Port_Input2_N003;
float l9_35=(floatArray[int(clamp(floor(float(sc_GetLocalInstanceID())+0.5)+9.9999997e-05,0.0,7.0))]*instensity)+radius;
l9_33=vec3(sin(l9_34)*l9_35,l9_35*cos(l9_34),Port_Value3_N014);
}
#else
{
float l9_36=((floor(float(sc_GetLocalInstanceID())+0.5)/sc_GeometryInfo.y)*3.1415927)*Port_Input2_N003;
float l9_37=(floatArray[int(clamp(floor(float(sc_GetLocalInstanceID())+0.5)+9.9999997e-05,0.0,7.0))]*instensity)+radius;
l9_33=vec3(sin(l9_36)*l9_37,l9_37*cos(l9_36),Port_Value3_N014);
}
#endif
l9_31=l9_33;
}
#endif
vec3 l9_38=(sc_ModelMatrixInverse*vec4(varPos,1.0)).xyz+l9_31;
vec3 l9_39;
vec3 l9_40;
vec3 l9_41;
if (l9_27)
...
l9_41=varTangent.xyz;
l9_40=l9_30;
l9_39=(sc_ModelMatrix*vec4(l9_38,1.0)).xyz;
}
varPos=l9_39;
...
#endif
gl_Position=l9_52;
Interpolator_gInstanceID=float(sc_GetLocalInstanceID());
}
...
float l9_3=clamp(floor(Interpolator_gInstanceID+0.5)/sc_GeometryInfo.y,0.0,1.0);
vec4 l9_4;
if (l9_3<Port_Position1_N036)
{
l9_4=mix(color1,color2,vec4(clamp(l9_3/Port_Position1_N036,0.0,1.0)));
}
else
{
vec4 l9_5;
if (l9_3<Port_Position2_N036)
{
l9_5=mix(color2,color3,vec4(clamp((l9_3-Port_Position1_N036)/(Port_Position2_N036-Port_Position1_N036),0.0,1.0)));
}
else
{
l9_5=mix(color3,color4,vec4(clamp((l9_3-Port_Position2_N036)/(1.0-Port_Position2_N036),0.0,1.0)));
}
l9_4=l9_5;
}
...
vec4 l9_11=mix(Port_Input0_N028,l9_4,vec4(max(1.0-pow(1.0-abs(dot(-normalize(sc_Camera.position-varPos),mat3(l9_1,cross(l9_2,l9_1)*varTangent.w,l9_2)*Port_Normal_N037)),Port_Exponent_N037),0.0)*Port_Intensity_N037));
vec4 l9_12=vec4(l9_11.xyz,baseColor.w);
...
{
l9_15=clamp(baseColor.w*2.0,0.0,1.0);
}
#else
{
float l9_16;
...
{
l9_16=clamp(dot(l9_12.xyz,vec3(baseColor.w)),0.0,1.0);
}
#else
{
float l9_17;
...
{
l9_18=(1.0-dot(l9_12.xyz,vec3(0.33333001)))*baseColor.w;
}
#else
{
float l9_19;
...
{
l9_19=(1.0-clamp(dot(l9_12.xyz,vec3(1.0)),0.0,1.0))*baseColor.w;
}
#else
{
float l9_20;
...
{
l9_20=clamp(dot(l9_12.xyz,vec3(1.0)),0.0,1.0)*baseColor.w;
}
#else
{
float l9_21;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_22=clamp(dot(l9_12.xyz,vec3(1.0)),0.0,1.0)*baseColor.w;
}
#else
{
float l9_23;
...
{
l9_23=dot(l9_12.xyz,vec3(0.33333001))*baseColor.w;
}
#else
{
float l9_24;
...
#else
{
vec2 l9_32=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
int l9_33;
...
#endif
l9_28=sc_SampleView(sc_ScreenTextureDims.xy,l9_32,sc_ScreenTextureLayout,l9_33,0.0,sc_ScreenTexture);
}
#endif
vec4 l9_34;
...
#endif
vec3 l9_36=mix(l9_34.xyz,definedBlend(l9_34.xyz,l9_12.xyz).xyz,vec3(baseColor.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_38=vec4(mix(vec3(1.0),l9_12.xyz,vec3(baseColor.w)),baseColor.w);
}
#else
{
vec4 l9_39;
...
{
l9_40=clamp(baseColor.w,0.0,1.0);
}
#else
{
l9_40=baseColor.w;
...
#endif
l9_39=vec4(l9_12.xyz*l9_40,l9_40);
}
#else
{
l9_39=l9_12;
...
#endif
int l9_49=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_48).xy);
...
if (l9_66==0)
{
l9_69=texture2D(sc_OITAlpha0,l9_61);
l9_68=texture2D(sc_OITDepthLow0,l9_61);
l9_67=texture2D(sc_OITDepthHigh0,l9_61);
}
else
{
l9_69=vec4(0.0);
...
if (l9_66==1)
{
l9_72=texture2D(sc_OITAlpha1,l9_61);
l9_71=texture2D(sc_OITDepthLow1,l9_61);
l9_70=texture2D(sc_OITDepthHigh1,l9_61);
}
else
{
l9_72=l9_69;
...
vec4 l9_87=texture2D(sc_OITFilteredDepthBoundsTexture,l9_61);
vec2 l9_88=l9_87.xy;
int l9_89;
#if (sc_SkinBonesCount>0)
{
