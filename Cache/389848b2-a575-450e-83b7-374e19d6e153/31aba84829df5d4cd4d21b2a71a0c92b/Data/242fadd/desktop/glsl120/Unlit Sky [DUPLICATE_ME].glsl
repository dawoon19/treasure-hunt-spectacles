...
//sampler sampler Tweak_N5SmpSC 2:17
...
//texture texture2D Tweak_N5 2:0:2:17
...
uniform vec4 Tweak_N5Size;
uniform vec4 Tweak_N5View;
uniform mat3 Tweak_N5Transform;
uniform vec4 Tweak_N5UvMinMax;
uniform vec4 Tweak_N5BorderColor;
...
#endif
#ifndef Tweak_N5HasSwappedViews
#define Tweak_N5HasSwappedViews 0
#elif Tweak_N5HasSwappedViews==1
#undef Tweak_N5HasSwappedViews
#define Tweak_N5HasSwappedViews 1
#endif
#ifndef Tweak_N5Layout
#define Tweak_N5Layout 0
#endif
#ifndef Tweak_N9
#define Tweak_N9 0
#elif Tweak_N9==1
...
#endif
#ifndef SC_USE_UV_TRANSFORM_Tweak_N5
#define SC_USE_UV_TRANSFORM_Tweak_N5 0
#elif SC_USE_UV_TRANSFORM_Tweak_N5==1
#undef SC_USE_UV_TRANSFORM_Tweak_N5
#define SC_USE_UV_TRANSFORM_Tweak_N5 1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_U_Tweak_N5
#define SC_SOFTWARE_WRAP_MODE_U_Tweak_N5 -1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_V_Tweak_N5
#define SC_SOFTWARE_WRAP_MODE_V_Tweak_N5 -1
#endif
#ifndef SC_USE_UV_MIN_MAX_Tweak_N5
#define SC_USE_UV_MIN_MAX_Tweak_N5 0
#elif SC_USE_UV_MIN_MAX_Tweak_N5==1
#undef SC_USE_UV_MIN_MAX_Tweak_N5
#define SC_USE_UV_MIN_MAX_Tweak_N5 1
#endif
#ifndef SC_USE_CLAMP_TO_BORDER_Tweak_N5
#define SC_USE_CLAMP_TO_BORDER_Tweak_N5 0
#elif SC_USE_CLAMP_TO_BORDER_Tweak_N5==1
#undef SC_USE_CLAMP_TO_BORDER_Tweak_N5
#define SC_USE_CLAMP_TO_BORDER_Tweak_N5 1
#endif
#ifndef Tweak_N33
#define Tweak_N33 0
#elif Tweak_N33==1
...
int Tweak_N5GetStereoViewIndex()
{
int l9_0;
#if (Tweak_N5HasSwappedViews)
{
l9_0=1-sc_GetStereoViewIndex();
}
#else
...
vec2 l9_1=(gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw;
vec2 l9_2=sc_ScreenCoordsGlobalToView(l9_1);
float l9_3=l9_0*Port_Speed_N025;
vec2 l9_4=(((l9_2-Port_Center_N001)*vec4(tiling,tiling/sc_Camera.aspect,tiling,tiling).xy)+Port_Center_N001)+(vec4(Tweak_N0,Tweak_N3,Tweak_N0,Tweak_N0).xy*l9_3);
vec4 l9_5=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),l9_4,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex);
float l9_6;
#if (Tweak_N9)
{
float l9_7;
if ((float((sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),l9_4,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex).w*sc_SampleTextureBiasOrLevel(Tweak_N5Dims.xy,Tweak_N5Layout,Tweak_N5GetStereoViewIndex(),varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_Tweak_N5)!=0),Tweak_N5Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N5,SC_SOFTWARE_WRAP_MODE_V_Tweak_N5),(int(SC_USE_UV_MIN_MAX_Tweak_N5)!=0),Tweak_N5UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N5)!=0),Tweak_N5BorderColor,0.0,Tweak_N5).x)<=Port_Input1_N014)*1.0)!=0.0)
{
l9_7=Port_Value1_N013;
}
else
{
l9_7=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),l9_4,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex).w*sc_SampleTextureBiasOrLevel(Tweak_N5Dims.xy,Tweak_N5Layout,Tweak_N5GetStereoViewIndex(),varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_Tweak_N5)!=0),Tweak_N5Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N5,SC_SOFTWARE_WRAP_MODE_V_Tweak_N5),(int(SC_USE_UV_MIN_MAX_Tweak_N5)!=0),Tweak_N5UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N5)!=0),Tweak_N5BorderColor,0.0,Tweak_N5).x;
}
l9_6=l9_7;
}
#else
...
{
float l9_9;
if ((float((sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),l9_4,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex).w*sc_SampleTextureBiasOrLevel(Tweak_N5Dims.xy,Tweak_N5Layout,Tweak_N5GetStereoViewIndex(),varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_Tweak_N5)!=0),Tweak_N5Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N5,SC_SOFTWARE_WRAP_MODE_V_Tweak_N5),(int(SC_USE_UV_MIN_MAX_Tweak_N5)!=0),Tweak_N5UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N5)!=0),Tweak_N5BorderColor,0.0,Tweak_N5).y)<=Port_Input1_N015)*1.0)!=0.0)
{
l9_9=Port_Value1_N016;
}
else
{
l9_9=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),l9_4,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex).w*sc_SampleTextureBiasOrLevel(Tweak_N5Dims.xy,Tweak_N5Layout,Tweak_N5GetStereoViewIndex(),varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_Tweak_N5)!=0),Tweak_N5Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N5,SC_SOFTWARE_WRAP_MODE_V_Tweak_N5),(int(SC_USE_UV_MIN_MAX_Tweak_N5)!=0),Tweak_N5UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N5)!=0),Tweak_N5BorderColor,0.0,Tweak_N5).y;
}
l9_8=l9_9;
}
#else
{
l9_8=Port_Default_N039;
}
#endif
float l9_10;
#if (Tweak_N34)
{
float l9_11;
if ((float((sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),l9_4,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex).w*sc_SampleTextureBiasOrLevel(Tweak_N5Dims.xy,Tweak_N5Layout,Tweak_N5GetStereoViewIndex(),varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_Tweak_N5)!=0),Tweak_N5Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N5,SC_SOFTWARE_WRAP_MODE_V_Tweak_N5),(int(SC_USE_UV_MIN_MAX_Tweak_N5)!=0),Tweak_N5UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N5)!=0),Tweak_N5BorderColor,0.0,Tweak_N5).z)<=Port_Input1_N018)*1.0)!=0.0)
{
l9_11=Port_Value1_N019;
}
else
{
l9_11=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),l9_4,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex).w*sc_SampleTextureBiasOrLevel(Tweak_N5Dims.xy,Tweak_N5Layout,Tweak_N5GetStereoViewIndex(),varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_Tweak_N5)!=0),Tweak_N5Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N5,SC_SOFTWARE_WRAP_MODE_V_Tweak_N5),(int(SC_USE_UV_MIN_MAX_Tweak_N5)!=0),Tweak_N5UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N5)!=0),Tweak_N5BorderColor,0.0,Tweak_N5).z;
}
l9_10=l9_11;
}
#else
{
l9_10=Port_Default_N052;
}
#endif
float l9_12=l9_6+l9_8;
float l9_13=l9_12+l9_10;
vec4 l9_14=vec4(l9_5.xyz,l9_13);
...
#else
{
vec2 l9_34=sc_ScreenCoordsGlobalToView(l9_1);
int l9_35;
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_50=sc_ScreenCoordsGlobalToView(l9_1);
...
#if (sc_OITCompositingPass)
{
vec2 l9_63=sc_ScreenCoordsGlobalToView(l9_1);
#if (sc_OITMaxLayers4Plus1)
{
