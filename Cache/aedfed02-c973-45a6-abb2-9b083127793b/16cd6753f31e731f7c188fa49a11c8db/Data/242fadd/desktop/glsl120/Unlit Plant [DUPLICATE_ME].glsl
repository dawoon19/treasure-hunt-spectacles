...
//sampler sampler Tweak_N9SmpSC 2:17
...
//texture texture2D Tweak_N9 2:0:2:17
...
uniform vec4 Tweak_N9Size;
uniform vec4 Tweak_N9View;
...
int Tweak_N9GetStereoViewIndex()
{
int l9_0;
...
{
float l9_7;
if ((float((sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),l9_4,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex).w*sc_SampleTextureBiasOrLevel(Tweak_N9Dims.xy,Tweak_N9Layout,Tweak_N9GetStereoViewIndex(),varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_Tweak_N9)!=0),Tweak_N9Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N9,SC_SOFTWARE_WRAP_MODE_V_Tweak_N9),(int(SC_USE_UV_MIN_MAX_Tweak_N9)!=0),Tweak_N9UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N9)!=0),Tweak_N9BorderColor,0.0,Tweak_N9).x)<=Port_Input1_N015)*1.0)!=0.0)
{
l9_7=Port_Value1_N016;
}
else
{
...
{
float l9_9;
if ((float((sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),l9_4,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex).w*sc_SampleTextureBiasOrLevel(Tweak_N9Dims.xy,Tweak_N9Layout,Tweak_N9GetStereoViewIndex(),varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_Tweak_N9)!=0),Tweak_N9Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N9,SC_SOFTWARE_WRAP_MODE_V_Tweak_N9),(int(SC_USE_UV_MIN_MAX_Tweak_N9)!=0),Tweak_N9UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N9)!=0),Tweak_N9BorderColor,0.0,Tweak_N9).y)<=Port_Input1_N018)*1.0)!=0.0)
{
l9_9=Port_Value1_N019;
}
else
{
...
{
float l9_11;
if ((float((sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),l9_4,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex).w*sc_SampleTextureBiasOrLevel(Tweak_N9Dims.xy,Tweak_N9Layout,Tweak_N9GetStereoViewIndex(),varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_Tweak_N9)!=0),Tweak_N9Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N9,SC_SOFTWARE_WRAP_MODE_V_Tweak_N9),(int(SC_USE_UV_MIN_MAX_Tweak_N9)!=0),Tweak_N9UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N9)!=0),Tweak_N9BorderColor,0.0,Tweak_N9).z)<=Port_Input1_N022)*1.0)!=0.0)
{
l9_11=Port_Value1_N024;
}
else
{
