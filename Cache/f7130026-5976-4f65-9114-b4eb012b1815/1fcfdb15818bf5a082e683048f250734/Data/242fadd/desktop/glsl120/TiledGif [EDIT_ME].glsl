...
//sampler sampler SegmentationMaskSmpSC 2:17
...
//texture texture2D SegmentationMask 2:0:2:17
...
uniform float Port_RangeMinA_N066;
uniform float Port_RangeMaxA_N066;
uniform float Port_RangeMinB_N066;
uniform float Port_RangeMaxB_N066;
uniform float Port_Import_N073;
uniform float Port_Import_N074;
uniform vec2 Port_Direction_N082;
uniform float Port_Speed_N082;
uniform float Port_RangeMinB_N086;
uniform float Port_RangeMaxB_N086;
uniform float Port_RangeMinA_N087;
uniform float Port_RangeMaxA_N087;
uniform float Port_RangeMinB_N087;
uniform float Port_RangeMaxB_N087;
uniform float Port_Value3_N088;
uniform float Port_Value4_N088;
uniform vec4 Port_Import_N093;
uniform vec4 Port_Import_N094;
uniform float Port_Input0_N105;
uniform float Port_Input1_N105;
uniform float Port_RangeMinA_N096;
uniform float Port_RangeMaxA_N096;
uniform float Port_RangeMinB_N096;
uniform float Port_RangeMaxB_N096;
uniform vec2 Port_Import_N097;
uniform vec2 Port_Import_N099;
uniform float Port_Input1_N104;
uniform float Port_Input2_N104;
uniform float Port_Input2_N107;
uniform vec2 Port_Center_N001;
uniform float Port_Speed_N025;
uniform vec4 Port_Import_N110;
uniform vec4 Port_Input2_N112;
uniform float Port_Import_N029;
uniform float Port_Import_N028;
uniform vec4 Port_Import_N027;
uniform float Port_Input1_N014;
uniform float Port_Value1_N013;
uniform float Port_Default_N037;
uniform float Port_Import_N031;
uniform float Port_Input1_N015;
uniform float Port_Value1_N016;
uniform float Port_Default_N039;
uniform float Port_Import_N032;
uniform float Port_Input1_N018;
uniform float Port_Value1_N019;
uniform float Port_Default_N052;
...
void Node114_If_else(float Bool1,vec4 Value1,vec4 Default,out vec4 Result,ssGlobals Globals)
{
#if (Tweak_N22)
{
vec2 l9_0=Globals.gScreenCoord;
vec2 l9_1=(((l9_0-vec2(Port_RangeMinA_N066))/vec2(Port_RangeMaxA_N066-Port_RangeMinA_N066))*(Port_RangeMaxB_N066-Port_RangeMinB_N066))+vec2(Port_RangeMinB_N066);
float l9_2=l9_1.x;
float l9_3=l9_1.y;
float l9_4=Globals.gTimeElapsed;
vec2 l9_5=((((vec2(atan(l9_3,l9_2))+(Port_Direction_N082*(l9_4*Port_Speed_N082)))-vec2(-3.1415927))/vec2(3.1415927-(-3.1415927)))*(Port_RangeMaxB_N086-Port_RangeMinB_N086))+vec2(Port_RangeMinB_N086);
float l9_6=(l9_2*l9_2)+(l9_3*l9_3);
float l9_7;
if (l9_6<=0.0)
{
l9_7=0.0;
...
float l9_8=l9_7-Port_RangeMinA_N087;
float l9_9=((l9_8/(Port_RangeMaxA_N087-Port_RangeMinA_N087))*(Port_RangeMaxB_N087-Port_RangeMinB_N087))+Port_RangeMinB_N087;
float l9_10=l9_5.x;
vec4 l9_11=vec4(l9_10,l9_9,Port_Value3_N088,Port_Value4_N088);
float l9_12=3.0*fract(l9_10+0.16666667);
float l9_13=2.0*fract(l9_12);
vec2 l9_14=l9_11.zz-((vec2(1.0,l9_13)-vec2(max(0.0,l9_13-1.0)))*(Port_Value3_N088*clamp(l9_9,0.0,1.0)));
...
vec4 l9_18=vec4(l9_17,Port_Value4_N088);
vec2 l9_19=Port_Import_N099-Port_Import_N097;
float l9_20=smoothstep(Port_Input0_N105,Port_Input1_N105,clamp((dot(((((Globals.Surface_UVCoord0-vec2(Port_RangeMinA_N096))/vec2(Port_RangeMaxA_N096-Port_RangeMinA_N096))*(Port_RangeMaxB_N096-Port_RangeMinB_N096))+vec2(Port_RangeMinB_N096))-Port_Import_N097,l9_19)/dot(l9_19,l9_19))+0.001,Port_Input1_N104+0.001,Port_Input2_N104+0.001)-0.001);
Value1=mix(mix(vec4(1.0)-l9_18,l9_18,vec4((l9_20*(1.0-l9_20))*Port_Input2_N107)),sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),(((Globals.gScreenCoord-Port_Center_N001)*vec4(tiling,tiling/sc_Camera.aspect,tiling,tiling).xy)+Port_Center_N001)+(vec4(Tweak_N0,Tweak_N3,Tweak_N0,Tweak_N0).xy*(Globals.gTimeElapsed*Port_Speed_N025)),(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex),Port_Input2_N112);
Result=Value1;
}
#else
{
Default=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),(((Globals.gScreenCoord-Port_Center_N001)*vec4(tiling,tiling/sc_Camera.aspect,tiling,tiling).xy)+Port_Center_N001)+(vec4(Tweak_N0,Tweak_N3,Tweak_N0,Tweak_N0).xy*(Globals.gTimeElapsed*Port_Speed_N025)),(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex);
Result=Default;
}
#endif
}
...
vec4 param_3;
Node114_If_else(0.0,vec4(0.0),vec4(0.0),param_3,ssGlobals(l9_1,l9_2,0.0,l9_4,varPackedTex.xy));
vec4 l9_5=param_3;
float l9_6;
#if (Tweak_N9)
{
float l9_7=l9_1*Port_Speed_N025;
vec2 l9_8=(((l9_4-Port_Center_N001)*vec4(tiling,tiling/sc_Camera.aspect,tiling,tiling).xy)+Port_Center_N001)+(vec4(Tweak_N0,Tweak_N3,Tweak_N0,Tweak_N0).xy*l9_7);
float l9_9;
if ((float((sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),l9_8,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex).w*sc_SampleTextureBiasOrLevel(SegmentationMaskDims.xy,SegmentationMaskLayout,SegmentationMaskGetStereoViewIndex(),varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_SegmentationMask)!=0),SegmentationMaskTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_SegmentationMask,SC_SOFTWARE_WRAP_MODE_V_SegmentationMask),(int(SC_USE_UV_MIN_MAX_SegmentationMask)!=0),SegmentationMaskUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_SegmentationMask)!=0),SegmentationMaskBorderColor,0.0,SegmentationMask).x)<=Port_Input1_N014)*1.0)!=0.0)
{
l9_9=Port_Value1_N013;
}
else
{
l9_9=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),l9_8,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex).w*sc_SampleTextureBiasOrLevel(SegmentationMaskDims.xy,SegmentationMaskLayout,SegmentationMaskGetStereoViewIndex(),varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_SegmentationMask)!=0),SegmentationMaskTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_SegmentationMask,SC_SOFTWARE_WRAP_MODE_V_SegmentationMask),(int(SC_USE_UV_MIN_MAX_SegmentationMask)!=0),SegmentationMaskUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_SegmentationMask)!=0),SegmentationMaskBorderColor,0.0,SegmentationMask).x;
}
l9_6=l9_9;
}
#else
{
l9_6=Port_Default_N037;
}
#endif
float l9_10;
#if (Tweak_N33)
{
float l9_11=l9_1*Port_Speed_N025;
vec2 l9_12=(((l9_4-Port_Center_N001)*vec4(tiling,tiling/sc_Camera.aspect,tiling,tiling).xy)+Port_Center_N001)+(vec4(Tweak_N0,Tweak_N3,Tweak_N0,Tweak_N0).xy*l9_11);
float l9_13;
if ((float((sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),l9_12,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex).w*sc_SampleTextureBiasOrLevel(SegmentationMaskDims.xy,SegmentationMaskLayout,SegmentationMaskGetStereoViewIndex(),varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_SegmentationMask)!=0),SegmentationMaskTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_SegmentationMask,SC_SOFTWARE_WRAP_MODE_V_SegmentationMask),(int(SC_USE_UV_MIN_MAX_SegmentationMask)!=0),SegmentationMaskUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_SegmentationMask)!=0),SegmentationMaskBorderColor,0.0,SegmentationMask).y)<=Port_Input1_N015)*1.0)!=0.0)
{
l9_13=Port_Value1_N016;
}
else
{
l9_13=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),l9_12,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex).w*sc_SampleTextureBiasOrLevel(SegmentationMaskDims.xy,SegmentationMaskLayout,SegmentationMaskGetStereoViewIndex(),varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_SegmentationMask)!=0),SegmentationMaskTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_SegmentationMask,SC_SOFTWARE_WRAP_MODE_V_SegmentationMask),(int(SC_USE_UV_MIN_MAX_SegmentationMask)!=0),SegmentationMaskUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_SegmentationMask)!=0),SegmentationMaskBorderColor,0.0,SegmentationMask).y;
}
l9_10=l9_13;
}
#else
{
l9_10=Port_Default_N039;
}
#endif
float l9_14;
#if (Tweak_N34)
{
float l9_15=l9_1*Port_Speed_N025;
vec2 l9_16=(((l9_4-Port_Center_N001)*vec4(tiling,tiling/sc_Camera.aspect,tiling,tiling).xy)+Port_Center_N001)+(vec4(Tweak_N0,Tweak_N3,Tweak_N0,Tweak_N0).xy*l9_15);
float l9_17;
if ((float((sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),l9_16,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex).w*sc_SampleTextureBiasOrLevel(SegmentationMaskDims.xy,SegmentationMaskLayout,SegmentationMaskGetStereoViewIndex(),varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_SegmentationMask)!=0),SegmentationMaskTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_SegmentationMask,SC_SOFTWARE_WRAP_MODE_V_SegmentationMask),(int(SC_USE_UV_MIN_MAX_SegmentationMask)!=0),SegmentationMaskUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_SegmentationMask)!=0),SegmentationMaskBorderColor,0.0,SegmentationMask).z)<=Port_Input1_N018)*1.0)!=0.0)
{
l9_17=Port_Value1_N019;
}
else
{
l9_17=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),l9_16,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex).w*sc_SampleTextureBiasOrLevel(SegmentationMaskDims.xy,SegmentationMaskLayout,SegmentationMaskGetStereoViewIndex(),varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_SegmentationMask)!=0),SegmentationMaskTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_SegmentationMask,SC_SOFTWARE_WRAP_MODE_V_SegmentationMask),(int(SC_USE_UV_MIN_MAX_SegmentationMask)!=0),SegmentationMaskUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_SegmentationMask)!=0),SegmentationMaskBorderColor,0.0,SegmentationMask).z;
}
l9_14=l9_17;
}
#else
{
l9_14=Port_Default_N052;
}
#endif
float l9_18=l9_6+l9_10;
float l9_19=l9_18+l9_14;
vec4 l9_20=vec4(l9_5.xyz,l9_19);
...
{
l9_24=clamp(dot(l9_20.xyz,vec3(l9_19)),0.0,1.0);
}
#else
{
float l9_25;
...
{
l9_26=(1.0-dot(l9_20.xyz,vec3(0.33333001)))*l9_19;
}
#else
{
float l9_27;
...
{
l9_27=(1.0-clamp(dot(l9_20.xyz,vec3(1.0)),0.0,1.0))*l9_19;
}
#else
{
float l9_28;
...
{
l9_28=clamp(dot(l9_20.xyz,vec3(1.0)),0.0,1.0)*l9_19;
}
#else
{
float l9_29;
...
{
l9_31=dot(l9_20.xyz,vec3(0.33333001))*l9_19;
}
#else
{
float l9_32;
...
#else
{
vec2 l9_40=sc_ScreenCoordsGlobalToView(l9_3);
int l9_41;
...
#endif
l9_36=sc_SampleView(sc_ScreenTextureDims.xy,l9_40,sc_ScreenTextureLayout,l9_41,0.0,sc_ScreenTexture);
}
#endif
vec4 l9_42;
...
#endif
vec3 l9_44=mix(l9_42.xyz,definedBlend(l9_42.xyz,l9_20.xyz).xyz,vec3(l9_19));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_46=vec4(mix(vec3(1.0),l9_20.xyz,vec3(l9_19)),l9_19);
}
#else
{
vec4 l9_47;
...
#endif
l9_47=vec4(l9_20.xyz*l9_48,l9_48);
}
#else
{
l9_47=l9_20;
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_56=sc_ScreenCoordsGlobalToView(l9_3);
...
#if (sc_OITCompositingPass)
{
vec2 l9_69=sc_ScreenCoordsGlobalToView(l9_3);
#if (sc_OITMaxLayers4Plus1)
{
