...
uniform vec4 Port_Import_N015;
uniform vec3 Port_Default_N019;
uniform float Port_Import_N013;
uniform vec2 Port_Input1_N003;
uniform float Port_Multiplier_N009;
...
uniform float Port_Value1_N023;
...
#else
{
l9_3=Port_Default_N019;
}
#endif
float l9_4=l9_0*Port_Multiplier_N009;
float l9_5;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
vec2 l9_6=vec2(floor(l9_2.x*10000.0)*9.9999997e-05,floor(l9_2.y*10000.0)*9.9999997e-05)*(vec2(noiseFrequency)*Port_Input1_N003);
float l9_7;
vec3 l9_8;
l9_7=0.0;
l9_8=vec3(8.0,0.0,0.0);
vec3 l9_9;
float l9_10;
int l9_11=-1;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
...
float l9_16=float(l9_11);
vec2 l9_17=vec2(l9_15,l9_16);
vec2 l9_18=VoronoiHash2D(l9_17+floor(l9_6),abs(l9_4)+1000.0);
float l9_19=distance(l9_17+l9_18,fract(l9_6));
if (l9_19<l9_9.x)
{
l9_13=vec3(l9_19,0.0,0.0);
l9_12=floor(l9_19*10000.0)*9.9999997e-05;
}
else
{
l9_13=l9_9;
...
#endif
float l9_20=1.0-l9_5;
float l9_21=(((l9_20-Port_RangeMinA_N002)/(Port_RangeMaxA_N002-Port_RangeMinA_N002))*(Port_RangeMaxB_N002-Port_RangeMinB_N002))+Port_RangeMinB_N002;
float l9_22;
if (Port_RangeMaxB_N002>Port_RangeMinB_N002)
{
l9_22=clamp(l9_21,Port_RangeMinB_N002,Port_RangeMaxB_N002);
}
else
{
l9_22=clamp(l9_21,Port_RangeMaxB_N002,Port_RangeMinB_N002);
}
vec3 l9_23=vec3(l9_22);
vec3 l9_24=mix(edgeColor.xyz,l9_3,l9_23);
float l9_25;
#if (Tweak_N40)
{
float l9_26;
if ((float((opaticy*sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex).x)<=Port_Input1_N022)*1.0)!=0.0)
{
l9_26=Port_Value1_N023;
}
else
{
l9_26=opaticy*sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex).x;
}
l9_25=l9_26;
}
#else
{
l9_25=Port_Default_N037;
}
#endif
float l9_27;
#if (Tweak_N41)
{
float l9_28;
if ((float((opaticy*sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex).y)<=Port_Input1_N025)*1.0)!=0.0)
{
l9_28=Port_Value1_N030;
}
else
{
l9_28=opaticy*sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex).y;
}
l9_27=l9_28;
}
#else
{
l9_27=Port_Default_N039;
}
#endif
float l9_29;
#if (Tweak_N42)
{
float l9_30;
if ((float((opaticy*sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex).z)<=Port_Input1_N033)*1.0)!=0.0)
{
l9_30=Port_Value1_N035;
}
else
{
l9_30=opaticy*sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex).z;
}
l9_29=l9_30;
}
#else
{
l9_29=Port_Default_N052;
}
#endif
float l9_31=l9_25+l9_27;
float l9_32=l9_31+l9_29;
vec4 l9_33=vec4(l9_24.x,l9_24.y,l9_24.z,vec4(0.0).w);
l9_33.w=l9_32;
...
{
l9_37=clamp(dot(l9_33.xyz,vec3(l9_32)),0.0,1.0);
}
#else
{
float l9_38;
...
{
l9_39=(1.0-dot(l9_33.xyz,vec3(0.33333001)))*l9_32;
}
#else
{
float l9_40;
...
{
l9_40=(1.0-clamp(dot(l9_33.xyz,vec3(1.0)),0.0,1.0))*l9_32;
}
#else
{
float l9_41;
...
{
l9_41=clamp(dot(l9_33.xyz,vec3(1.0)),0.0,1.0)*l9_32;
}
#else
{
float l9_42;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_43=clamp(dot(l9_33.xyz,vec3(1.0)),0.0,1.0)*l9_32;
}
#else
{
float l9_44;
...
{
l9_44=dot(l9_33.xyz,vec3(0.33333001))*l9_32;
}
#else
{
float l9_45;
...
#else
{
vec2 l9_53=sc_ScreenCoordsGlobalToView(l9_1);
int l9_54;
...
#endif
l9_49=sc_SampleView(sc_ScreenTextureDims.xy,l9_53,sc_ScreenTextureLayout,l9_54,0.0,sc_ScreenTexture);
}
#endif
vec4 l9_55;
...
#endif
vec3 l9_57=mix(l9_55.xyz,definedBlend(l9_55.xyz,l9_33.xyz).xyz,vec3(l9_32));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_59=vec4(mix(vec3(1.0),l9_33.xyz,vec3(l9_32)),l9_32);
}
#else
{
vec4 l9_60;
...
#if (sc_OITCompositingPass)
{
vec2 l9_82=sc_ScreenCoordsGlobalToView(l9_1);
#if (sc_OITMaxLayers4Plus1)
{
